...
CHARTS: Dict[str, Dict[str, Any]] = {
    ...
    '__US_RATES_CREDIT__': {
        ...
        'series': [
            {'key': 'fedfunds', 'name': '基準利率', 'scale': 'left', 'color': '#E2E8F0', 'style': 'line', 'unit': '%',
             'source': 'fred', 'fred': 'FEDFUNDS', 'fallback': 'nyfed_effr', 'seed': 'fedfunds.csv'},
            {'key': 'us10y', 'name': '10年期公債殖利率', 'scale': 'left', 'color': '#FBBF24', 'style': 'line', 'unit': '%',
             'source': 'fred', 'fred': 'DGS10', 'fallback': 'h15_10y', 'seed': 'us10y.csv'},
            {'key': 'baml_ig', 'name': '美林投資級總報酬', 'scale': 'right', 'color': '#38BDF8', 'style': 'line', 'unit': '',
             'source': 'fred', 'fred': 'BAMLCC0A0CMTRIV', 'fallback': 'yahoo_adj', 'symbol': 'LQD', 'seed': 'baml_ig.csv'},
            {'key': 'baml_hy', 'name': '美林高收益總報酬', 'scale': 'right', 'color': '#F87171', 'style': 'line', 'unit': '',
