...
ok(/data-layout="5col-2zone"/.test(pl) &&
  ...
  'pulse dash is known-good 5col-2zone (git 3cab212; not patched flex/2col)');
...
ok(/一行五框 × 上下兩區/.test(pl) || /一行五框/.test(pl),
  'pulse surfaces 一行五框 layout contract in source');
(function () {
