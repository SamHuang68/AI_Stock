...
ok(sandbox.__portrait.label === '技術統計 · 2 / 6', 'bottom index includes line chart as page one');
ok(sandbox.__portrait.dots === 6, 'bottom index renders six workspace pages (chart + 5 tabs)');
